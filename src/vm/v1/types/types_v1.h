 ...
 * Modified:
 *   February 7, 2025 at 7:37:15 AM GMT+3
 *
 */
/*
...
/* definition */
#ifdef INLINE
const type_methods* type = &PRIVATE_API(type_methods_definition);
#else
/* definition */
static const type_methods* type = &PRIVATE_API(type_methods_definition);
#endif
