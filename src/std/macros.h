...
#define ERROR_INVALID_POINTER(...) ERROR(ERROR_INVALID_POINTER, __func__, VM_STRINGIFY(__VA_ARGS__))
#define ERROR_INVALID_ADDRESS(...) ERROR(ERROR_INVALID_ADDRESS, __func__, VM_STRINGIFY(__VA_ARGS__))
#define ERROR_INVALID_ARGUMENT(...) ERROR(ERROR_INVALID_ARGUMENT, __func__, VM_STRINGIFY(__VA_ARGS__))
#define ERROR_INVALID_TYPEID(...) ERROR(ERROR_INVALID_TYPEID, __func__, VM_STRINGIFY(__VA_ARGS__))
#define ERROR_INVALID_TYPE(...) ERROR(ERROR_INVALID_TYPE, __func__, VM_STRINGIFY(__VA_ARGS__))
...
#define ERROR_INVALID_POINTER(...) ERROR(ERROR_INVALID_POINTER)
#define ERROR_INVALID_ADDRESS(...) ERROR(ERROR_INVALID_ADDRESS)
#define ERROR_INVALID_ARGUMENT(...) ERROR(ERROR_INVALID_ARGUMENT)
#define ERROR_INVALID_TYPEID(...) ERROR(ERROR_INVALID_TYPEID)
#define ERROR_INVALID_TYPE(...) ERROR(ERROR_INVALID_TYPE)
