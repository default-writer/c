...
/* returns class type id */
 LPTR class_get_type();
/* returns class data*/
 const void* class_get_data(const struct class *class);
/* sets the class data */
 void class_set_data(const struct class *class, const void* data);

/* sets the class context */
 void context_enter(const struct class* class);
/* resets the class context */
 const struct class* context_leave();
/* proxy for the class function get_data() */
 const void* context_get_data();
/* proxy for the class function set_data(const void*)*/
 void context_set_data(const void* data);
