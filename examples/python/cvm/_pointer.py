...
from csys._error import CError, CException, CVirtualMachineNotInitializedException
...
class CType(ctypes.c_uint64):
    ...
    """Represents a pointer to a null-terminated string (TYPE_STRING_REFERENCE)."""
    TYPE_USER = 7
